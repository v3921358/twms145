...
public class MapleGuild implements java.io.Serializable {
    ...
    public static MapleGuildResponse sendInvite(final MapleClient c, final String targetName) {
        ...
        mc.getClient().getSession().writeAndFlush(GuildPacket.guildInvite(c.getPlayer().getGuildId(), c.getPlayer().getName(), c.getPlayer().getLevel(), c.getPlayer().getJob()));
        return null;
    }
