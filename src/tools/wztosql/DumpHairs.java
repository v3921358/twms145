 ...
 * @author Itzik
 */
public class DumpHairs {

    public static void main(String[] args) throws IOException {
        MapleDataProvider data;
        data = MapleDataProviderFactory.getDataProvider("Character.wz/Hair");
        MapleDataDirectoryEntry root;
        StringBuilder sb = new StringBuilder();
        FileOutputStream out;
        out = new FileOutputStream("Styler.js", false);
        LinkedList maleHair1 = new LinkedList();
        LinkedList maleHair2 = new LinkedList();
        ...
        LinkedList hairList = new LinkedList();
        for (MapleDataFileEntry topDir : root.getFiles()) {
            hairList.add(Integer.parseInt(topDir.getName().substring(0, 8)));
        }
        LinkedList maleFace = new LinkedList();
        LinkedList femaleFace = new LinkedList();
    ...
    public static String createStyler(List<Integer> maleHair1, List<Integer> maleHair2, List<Integer> maleHair3, List<Integer> femaleHair1, List<Integer> femaleHair2, List<Integer> femaleHair3, List<Integer> maleFace, List<Integer> femaleFace, List<Integer> hairList, List<Integer> faceList) {
        ...
        addLine(sb, "   cm.sendSimple(\"Sup, I'm KIN! I can turn you into a sexy beast!\\r\\nWould you like me to do that for you?\\r\\nChoose what you'd like to change:\\r\\n#L0#Skin#l\\r\\n#L1#Hair 1#l\" + (v13 == 0 ? ((\"\" + v7 != v9 ? \"\\r\\n#L2#Hair 2#l\" : \"\") + (\"\" + v7 != v11 ? \"\\r\\n#L3#Hair 3#l\" : \"\")) : ((\"\" + v8 != v10 ? \"\\r\\n#L2#Hair 2#l\" : \"\") + (\"\" + v8 != v12 ? \"\\r\\n#L3#Hair 3#l\" : \"\"))) + \"\\r\\n#L4#Hair Color#l\\r\\n#L5#Face#l\\r\\n#L6#Eye Color#l\");");
        addLine(sb, "}");
        addLine(sb, "");
        ...
        addLine(sb, "   cm.sendStyle(\"Pick one?\", v17);");
        addLine(sb, "}");
        addLine(sb, "");
